...
@section('page-title', 'Submit New Letter')

@section('page-content')
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4 mt-3">
        <div>
            <h2 style="font-size: 20px; font-weight: 600; color: #4E5967; margin: 0 0 8px 0;">Submit New Letter</h2>
            <p style="font-size: 14px; color: #6A7380; margin: 0;">Fill in the form below to submit a new outgoing letter request.</p>
        </div>
        ...
        <div class="card-body" style="padding: 32px;">
            <form action="{{ route('user.outgoing-letters.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4 pb-3" style="border-bottom: 1px solid #f1f3f8;">
                    <h3 style="font-size: 16px; font-weight: 600; color: #1A2744; margin-bottom: 16px;">Letter Type</h3>
                    <div class="mb-3">
                        ...
                        <select name="letter_type" id="letter_type" class="form-select @error('letter_type') is-invalid @enderror" style="height: 38px; border-radius: 6px;" required>
                            <option value="" disabled {{ old('letter_type') ? '' : 'selected' }}>Select letter type</option>
                            <option value="recommendation" {{ old('letter_type') == 'recommendation' ? 'selected' : '' }}>Recommendation Letter</option>
                            <option value="active_certificate" {{ old('letter_type') == 'active_certificate' ? 'selected' : '' }}>Active Member Certificate</option>
                            <option value="assignment" {{ old('letter_type') == 'assignment' ? 'selected' : '' }}>Assignment Letter</option>
                        </select>
                        @error('letter_type')
                ...
                <div class="mb-4 pb-3" style="border-bottom: 1px solid #f1f3f8;">
                    <h3 style="font-size: 16px; font-weight: 600; color: #1A2744; margin-bottom: 16px;">Letter Details</h3>

                    <div class="mb-3">
                        <label for="related_name" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Name of Person Concerned <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="purpose" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Purpose / Reason <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="addressed_to" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Addressed To <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="letter_body" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Letter Content <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="file_path" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Supporting Document (PDF/Image)</label>
                ...
                <div id="assignment-fields" class="mb-4 pb-3" style="border-bottom: 1px solid #f1f3f8; display: none;">
                    <h3 style="font-size: 16px; font-weight: 600; color: #1A2744; margin-bottom: 16px;">Assignment Details</h3>

                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="event_name" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Event Name</label>
                        ...
                        <div class="col-md-6">
                            <label for="event_date" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Event Date</label>
                    ...
                    <div class="mb-3">
                        <label for="event_location" class="form-label" style="font-size: 14px; font-weight: 500; color: #4E5967;">Event Location</label>
                ...
                <div class="d-flex justify-content-end pt-3">
                    <a href="{{ route('user.outgoing-letters.index') }}" class="btn btn-link text-muted me-3" style="text-decoration: none; height: 40px; border-radius: 6px;">Cancel</a>
                    <button type="submit" class="btn btn-primary px-4" style="height: 40px; border-radius: 6px; background-color: #066FD1; border-color: #066FD1;">Submit Letter</button>
                </div>
            </form>
        </div>
    </div>
