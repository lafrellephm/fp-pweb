...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4 mt-3">
        <div>
            <h2 style="font-size: 20px; font-weight: 600; color: #4E5967; margin: 0 0 8px 0;">My Letters</h2>
        ...
        <form action="{{ route('user.outgoing-letters.index') }}" method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                ...
                <select name="type" id="type" class="form-select" style="height: 38px; border-radius: 6px;">
                    ...
                    <option value="recommendation" {{ request('type') === 'recommendation' ? 'selected' : '' }}>Recommendation</option>
                    <option value="active_certificate" {{ request('type') === 'active_certificate' ? 'selected' : '' }}>Active Certificate</option>
            ...
            <table class="table table-vcenter table-nowrap mb-0">
                <thead style="background-color: #F8FAFC;">
                    <tr>
                        ...
                        <th style="font-size: 12px; font-weight: 600; color: #6A7380; text-transform: uppercase;">Purpose</th>
                        <th style="font-size: 12px; font-weight: 600; color: #6A7380; text-transform: uppercase;">Addressed To</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <a href="{{ route('user.outgoing-letters.show', $letter->id) }}" class="btn btn-sm btn-outline-info" style="border-radius: 6px;">View</a>
                                    @if($letter->status === 'draft')
