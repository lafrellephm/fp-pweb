...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4 mt-3">
        <div>
            <h2 style="font-size: 20px; font-weight: 600; color: #4E5967; margin: 0 0 8px 0;">Edit Letter</h2>
        ...
        <div class="card-body" style="padding: 32px;">
            <form action="{{ route('user.outgoing-letters.update', $letter->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4 pb-3" style="border-bottom: 1px solid #f1f3f8;">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="letter_type" id="letter_type" class="form-select @error('letter_type') is-invalid @enderror" style="height: 38px; border-radius: 6px;" required>
                            ...
                            <option value="recommendation" {{ old('letter_type', $letter->letter_type) == 'recommendation' ? 'selected' : '' }}>Recommendation Letter</option>
                            <option value="active_certificate" {{ old('letter_type', $letter->letter_type) == 'active_certificate' ? 'selected' : '' }}>Active Member Certificate</option>
                            <option value="assignment" {{ old('letter_type', $letter->letter_type) == 'assignment' ? 'selected' : '' }}>Assignment Letter</option>
                        </select>
                        @error('letter_type')
                ...
                <div class="d-flex justify-content-end pt-3">
                    <a href="{{ route('user.outgoing-letters.show', $letter->id) }}" class="btn btn-link text-muted me-3" style="text-decoration: none; height: 40px; border-radius: 6px;">Cancel</a>
