...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4 mt-3">
        <div>
            <h2 style="font-size: 20px; font-weight: 600; color: #4E5967; margin: 0 0 8px 0;">Ubah Incoming Letter</h2>
            <p style="font-size: 14px; color: #6A7380; margin: 0;">Perbarui information for this incoming letter.</p>
        </div>
