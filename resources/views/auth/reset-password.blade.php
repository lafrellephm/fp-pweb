...
<head>
    ...
    <title>Atur Ulang Kata Sandi - Satu Surat</title>
    <!-- Scripts -->
            ...
            <div class="w-100" style="max-width: 550px;">
                <div class="card shadow-lg border-0 rounded-4" style="min-height: 600px;">
                    <div class="card-body p-5 d-flex flex-column justify-content-center">
                        <h2 class="fw-bold mb-4 text-center" style="font-size: 2.5rem;">Atur Ulang Kata Sandi</h2>
                        ...
                        <form method="POST" action="{{ route('password.store') }}" class="d-flex flex-column gap-3">
                            ...
                            <div>
                                ...
                                <input id="email" type="email" class="form-control form-control-lg py-3" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" placeholder="nama@email.com">
                                @error('email')
                            ...
                            <!-- Kata Sandi -->
                            <div>
                                <label for="password" class="form-label fw-semibold fs-5">{{ __('Kata Sandi Baru') }}</label>
                            ...
                            <div>
                                <label for="password_confirmation" class="form-label fw-semibold fs-5">{{ __('Konfirmasi Kata Sandi Baru') }}</label>
