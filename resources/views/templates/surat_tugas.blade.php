...
<head>
    ...
    <title>Surat Tugas Ã¢â‚¬â€ Organisasi PWEB</title>
...
<body>
    <div class="letter-container">
        ...
        <div class="letter-body">
            <p>Yang bertanda tangan di bawah ini, Admin Organisasi PWEB, dengan ini memberikan tugas kepada:</p>
            ...
            <p>Untuk mewakili Organisasi PWEB pada kegiatan berikut:</p>
            ...
            <table class="event-details">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $letter->event_date ? $letter->event_date->translatedFormat('d F Y') : '-' }}</td>
                </tr>
                <tr>
            ...
            <p>Surat tugas ini ditujukan kepada <strong>{{ $letter->addressed_to }}</strong> untuk dapat dipergunakan sebagaimana mestinya.</p>
