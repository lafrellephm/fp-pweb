...
<head>
    ...
    <title>Surat Rekomendasi Ã¢â‚¬â€ Organisasi PWEB</title>
...
<body>
    <div class="letter-container">
        ...
        <div class="letter-body">
            <p>Yang bertanda tangan di bawah ini, Admin Organisasi PWEB, dengan ini memberikan rekomendasi kepada:</p>
            ...
            <table class="mb-3 ms-4">
                ...
                <tr>
                    <td style="padding: 4px 12px 4px 0; font-weight: 500;">Keperluan</td>
                    <td style="padding: 4px 8px;">:</td>
                    <td style="padding: 4px 0;">{{ $letter->purpose }}</td>
                </tr>
            </table>

            <p>Berdasarkan data dan pengamatan kami, yang bersangkutan merupakan anggota yang aktif dan bertanggung jawab di lingkungan Organisasi PWEB. Kami merekomendasikan yang bersangkutan untuk keperluan sebagaimana tersebut di atas.</p>

            <p>Surat rekomendasi ini ditujukan kepada <strong>{{ $letter->addressed_to }}</strong> untuk dapat dipergunakan sebagaimana mestinya.</p>
